...
const Price = () => {
  return (
    <section className="py-28 bg-white md:mx-0 mx-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 md:gap-9 gap-12 max-w-6xl mx-auto p-8 lg:p-0 ">
        {pricingPlans.map((plan, index) => (
          <div key={index} className="rounded-lg border border-gray-100  h-auto">
