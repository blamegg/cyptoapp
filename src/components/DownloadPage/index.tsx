    ...
    <>
      ...
      >
        <div className="w-1/2 justify-center ml-32 items-center h-auto relative">
           <div
            className={`mt-20  md:h-550 md:w-550 rounded-full border-50 border-white md:border-black hidden lg:flex items-center justify-center transition-opacity duration-500 ${
          ...
          >
           ...
           <motion.img
            className='absolute lg:block hidden md:h-650  -translate-y-92 translate-x-24'
            src={img4.src}
