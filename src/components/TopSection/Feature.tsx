  ...
  return (
    <div>
      <div className='text-center mb-20'>
        ...
        <p className='text-xs font-bold text-gray-700'>WHAT DO YOU GET</p>
      </div>
      <div className="flex justify-between space-x-6 mx-20">
        {features.map((feature, index) => (
          <motion.div
            key={index}
            className="relative bg-white p-6 pt-10 shadow-md min-h-96 rounded-md text-center overflow-hidden"
            whileHover="hover"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <motion.p
                className={`text-gray-600 text-lg font-thin px-4 mb-20 transition-colors duration-300 ${hovered === index ? "text-white" : 'text-black'}`}
              >
                {feature.description}
              </motion.p>
              <motion.a
                href="#"
                className={`text-gray-800 font-semibold hover:underline transition-colors duration-300 ${hovered === index ? "text-yellow-500" : 'text-black'}`}
              >
                Learn More &#62;
              </motion.a>
            </div>
