    ...
    >
      ...
      <div className="w-full md:w-[45vw] xl:w-[45vw]  md:pl-16 sm:p-10 p-10 md:p-0 lg:p-0 xl:p-0  lg:pl-24 xl:pl-32 flex flex-col space-y-6 pr-8">
        ...
        <div className="flex space-x-4 translate-y-6">
          <motion.button
            className="bg-customYellow md:text-10 xl:text-sm text-8 hover:bg-white hover:text-black whitespace-nowrap flex items-center font-bold gap-4 text-white md:px-3 xl:px-6 md:py-2 xl:py-3 px-3 py-2"
